...
const PreviousQualification = (props) => {
  ...
  return (
    <>
      <Divider horizontal>Previous Qualification</Divider>
      <Form onSubmit={props.save}>
        ...
        <Form.Field required>
          ...
          <Dropdown
            ...
            selection
            search
            name="selectedPreviousProgrammeYear"
        ...
        <Form.Field required>
          ...
          <Dropdown
            ...
            selection
            search
            name="selectedPreviousQualification"
            label={"Qualification"}
            placeholder={
        ...
        {props.isForAgent ? (
          <Button as="a" href={`${props.backLink}`}>
            Back
          </Button>
        ) : (
          ""
...
export default PreviousQualification;
